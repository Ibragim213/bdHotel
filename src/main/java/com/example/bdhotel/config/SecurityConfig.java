...
import com.example.bdhotel.service.ClientDetailsServiceImpl;
import com.example.bdhotel.security.TokenFilter;
...
public class SecurityConfig {
    @Autowired
    private ClientDetailsServiceImpl userService;
    @Autowired
    @Lazy
